...
MOTHER_DIR="/local_disk/pegasus/laboinfo/mquillot/data/masseffect/prot_zero_wotest_switch"
EXP_DIR="exp/prot_zero_wofold/pv_from_xvkaldi_mod-gressia_mod/${1}"
FEATURES_FILE="/local_disk/pegasus/laboinfo/mquillot/knowledge_distillation/exp/prot_zero_wofold/xv_switch/1.0/teacher/masseffect_pvectors.txt"
INPUT_DIM=64
